import styles from "./ImgLoaderSVG.module.css";

interface ImgLoaderSvg {
    imgLoaded: boolean;
}

function ImgLoaderSVG({ imgLoaded }: ImgLoaderSvg) {
    const className = imgLoaded
        ? `${styles.svgWrapper} ${styles.imgHasLoaded}`
        : styles.svgWrapper;
